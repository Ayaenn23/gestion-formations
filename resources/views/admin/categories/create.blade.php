...
@php $pageTitle = 'Nouvelle catégorie'; @endphp
...
<div class="max-w-xl">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-lg font-bold text-gray-900">Nouvelle catégorie</h2>
            <p class="text-sm text-gray-500">Ajoutez une catégorie en FR et EN</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.categories.store') }}"
        ...
        <div>
            ...
            <input id="name_fr" type="text" name="name_fr" value="{{ old('name_fr') }}" required
