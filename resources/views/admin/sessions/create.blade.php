...
@php $pageTitle = 'Nouvelle session'; @endphp
...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-lg font-bold text-gray-900">Nouvelle session</h2>
            <p class="text-sm text-gray-500">Planifiez une nouvelle session de formation</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.sessions.store') }}"
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input id="lien_reunion" type="url" name="lien_reunion" value="{{ old('lien_reunion') }}"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
            </div>
        </div>
