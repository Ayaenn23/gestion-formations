...
@php $pageTitle = 'Nouvel utilisateur'; @endphp
...
<div class="max-w-xl">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-lg font-bold text-gray-900">Nouvel utilisateur</h2>
            <p class="text-sm text-gray-500">Créez un nouveau compte utilisateur</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.users.store') }}"
        ...
        <div>
            <label for="password" class="block text-sm font-medium text-gray-700 mb-1.5">Mot de passe <span class="text-red-500">*</span></label>
